  ...
  return createBrowserRouter([
    ...
    },
    {
      ...
      children: [
        ...
        { path: "dashboard", element: <DashboardPage currentUser={context.currentUser!} refreshKey={context.refreshKey} /> },
        ...
        { path: "ports", element: guarded("/ports", <PortManagementPage refreshKey={context.refreshKey} />) },
        { path: "ports/new", element: guarded("/ports", <PortCreatePage />) },
        {
          path: "ports/:portId",
          element: guarded("/ports", <PortManagementPage refreshKey={context.refreshKey} detailMode />),
        },
        { path: "users/new", element: guarded("/users/new", <UserFormPage currentUser={context.currentUser!} mode="create" />) },
        { path: "users/:userId/edit", element: guarded("/users/edit", <UserFormPage currentUser={context.currentUser!} mode="edit" />) },
        { path: "users", element: guarded("/users", <UsersPage currentUser={context.currentUser!} refreshKey={context.refreshKey} />) },
        { path: "risk-config", element: guarded("/risk-config", <RiskConfigPage currentUser={context.currentUser!} />) },
        { path: "sop-rules", element: guarded("/sop-rules", <SopRulesPage currentUser={context.currentUser!} />) },
